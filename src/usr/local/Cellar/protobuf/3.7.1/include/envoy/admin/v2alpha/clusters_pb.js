...
goog.object.extend(proto, envoy_admin_v2alpha_metrics_pb);
...
proto.envoy.admin.v2alpha.HostHealthStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pendingDynamicRemoval: jspb.Message.getFieldWithDefault(msg, 5, false),
    pendingActiveHc: jspb.Message.getFieldWithDefault(msg, 6, false),
...
proto.envoy.admin.v2alpha.HostHealthStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setPendingDynamicRemoval(value);
      break;
    case 6:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setPendingActiveHc(value);
      break;
    case 3:
...
proto.envoy.admin.v2alpha.HostHealthStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPendingDynamicRemoval();
  if (f) {
    writer.writeBool(
      5,
      f
...
/**
 * optional bool pending_dynamic_removal = 5;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.envoy.admin.v2alpha.HostHealthStatus.prototype.getPendingDynamicRemoval = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 5, false));
};


/** @param {boolean} value */
proto.envoy.admin.v2alpha.HostHealthStatus.prototype.setPendingDynamicRemoval = function(value) {
  jspb.Message.setProto3BooleanField(this, 5, value);
};


/**
 * optional bool pending_active_hc = 6;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.envoy.admin.v2alpha.HostHealthStatus.prototype.getPendingActiveHc = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 6, false));
};


/** @param {boolean} value */
proto.envoy.admin.v2alpha.HostHealthStatus.prototype.setPendingActiveHc = function(value) {
