...
goog.exportSymbol('proto.envoy.data.core.v2alpha.DegradedHealthyHost', null, global);
...
goog.exportSymbol('proto.envoy.data.core.v2alpha.NoLongerDegradedHost', null, global);
/**
 ...
 * @constructor
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.envoy.data.core.v2alpha.DegradedHealthyHost, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.envoy.data.core.v2alpha.DegradedHealthyHost.displayName = 'proto.envoy.data.core.v2alpha.DegradedHealthyHost';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.envoy.data.core.v2alpha.NoLongerDegradedHost, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.envoy.data.core.v2alpha.NoLongerDegradedHost.displayName = 'proto.envoy.data.core.v2alpha.NoLongerDegradedHost';
}
 ...
 * @const
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.oneofGroups_ = [[4,5,7,8,9]];
...
proto.envoy.data.core.v2alpha.HealthCheckEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    degradedHealthyHost: (f = msg.getDegradedHealthyHost()) && proto.envoy.data.core.v2alpha.DegradedHealthyHost.toObject(includeInstance, f),
    noLongerDegradedHost: (f = msg.getNoLongerDegradedHost()) && proto.envoy.data.core.v2alpha.NoLongerDegradedHost.toObject(includeInstance, f),
...
proto.envoy.data.core.v2alpha.HealthCheckEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.envoy.data.core.v2alpha.DegradedHealthyHost;
      reader.readMessage(value,proto.envoy.data.core.v2alpha.DegradedHealthyHost.deserializeBinaryFromReader);
      msg.setDegradedHealthyHost(value);
      break;
    case 9:
      var value = new proto.envoy.data.core.v2alpha.NoLongerDegradedHost;
      reader.readMessage(value,proto.envoy.data.core.v2alpha.NoLongerDegradedHost.deserializeBinaryFromReader);
      msg.setNoLongerDegradedHost(value);
      break;
    case 6:
...
proto.envoy.data.core.v2alpha.HealthCheckEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDegradedHealthyHost();
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.envoy.data.core.v2alpha.DegradedHealthyHost.serializeBinaryToWriter
    );
  }
  f = message.getNoLongerDegradedHost();
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.envoy.data.core.v2alpha.NoLongerDegradedHost.serializeBinaryToWriter
    );
  }
...
/**
 * optional DegradedHealthyHost degraded_healthy_host = 8;
 * @return {?proto.envoy.data.core.v2alpha.DegradedHealthyHost}
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.getDegradedHealthyHost = function() {
  return /** @type{?proto.envoy.data.core.v2alpha.DegradedHealthyHost} */ (
    jspb.Message.getWrapperField(this, proto.envoy.data.core.v2alpha.DegradedHealthyHost, 8));
};


/** @param {?proto.envoy.data.core.v2alpha.DegradedHealthyHost|undefined} value */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.setDegradedHealthyHost = function(value) {
  jspb.Message.setOneofWrapperField(this, 8, proto.envoy.data.core.v2alpha.HealthCheckEvent.oneofGroups_[0], value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.clearDegradedHealthyHost = function() {
  this.setDegradedHealthyHost(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.hasDegradedHealthyHost = function() {
  return jspb.Message.getField(this, 8) != null;
};


/**
 * optional NoLongerDegradedHost no_longer_degraded_host = 9;
 * @return {?proto.envoy.data.core.v2alpha.NoLongerDegradedHost}
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.getNoLongerDegradedHost = function() {
  return /** @type{?proto.envoy.data.core.v2alpha.NoLongerDegradedHost} */ (
    jspb.Message.getWrapperField(this, proto.envoy.data.core.v2alpha.NoLongerDegradedHost, 9));
};


/** @param {?proto.envoy.data.core.v2alpha.NoLongerDegradedHost|undefined} value */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.setNoLongerDegradedHost = function(value) {
  jspb.Message.setOneofWrapperField(this, 9, proto.envoy.data.core.v2alpha.HealthCheckEvent.oneofGroups_[0], value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.clearNoLongerDegradedHost = function() {
  this.setNoLongerDegradedHost(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.data.core.v2alpha.HealthCheckEvent.prototype.hasNoLongerDegradedHost = function() {
 ...
 * @return {!Object}
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.data.core.v2alpha.DegradedHealthyHost.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.data.core.v2alpha.DegradedHealthyHost} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.envoy.data.core.v2alpha.DegradedHealthyHost}
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.data.core.v2alpha.DegradedHealthyHost;
  return proto.envoy.data.core.v2alpha.DegradedHealthyHost.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.data.core.v2alpha.DegradedHealthyHost} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.data.core.v2alpha.DegradedHealthyHost}
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.data.core.v2alpha.DegradedHealthyHost.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.data.core.v2alpha.DegradedHealthyHost} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.core.v2alpha.DegradedHealthyHost.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.data.core.v2alpha.NoLongerDegradedHost.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.data.core.v2alpha.NoLongerDegradedHost} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.envoy.data.core.v2alpha.NoLongerDegradedHost}
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.data.core.v2alpha.NoLongerDegradedHost;
  return proto.envoy.data.core.v2alpha.NoLongerDegradedHost.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.data.core.v2alpha.NoLongerDegradedHost} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.data.core.v2alpha.NoLongerDegradedHost}
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.data.core.v2alpha.NoLongerDegradedHost.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.data.core.v2alpha.NoLongerDegradedHost} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.core.v2alpha.NoLongerDegradedHost.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
