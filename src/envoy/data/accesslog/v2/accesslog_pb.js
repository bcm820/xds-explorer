...
goog.exportSymbol('proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties', null, global);
goog.exportSymbol('proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName', null, global);
...
proto.envoy.data.accesslog.v2.AccessLogCommon.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    upstreamTransportFailureReason: jspb.Message.getFieldWithDefault(msg, 18, "")
  };
...
proto.envoy.data.accesslog.v2.AccessLogCommon.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 18:
      var value = /** @type {string} */ (reader.readString());
      msg.setUpstreamTransportFailureReason(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.envoy.data.accesslog.v2.AccessLogCommon.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getUpstreamTransportFailureReason();
  if (f.length > 0) {
    writer.writeString(
      18,
      f
...
/**
 * optional string upstream_transport_failure_reason = 18;
 * @return {string}
 */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.getUpstreamTransportFailureReason = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 18, ""));
};


/** @param {string} value */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.setUpstreamTransportFailureReason = function(value) {
...
proto.envoy.data.accesslog.v2.ResponseFlags.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    streamIdleTimeout: jspb.Message.getFieldWithDefault(msg, 17, false)
  };
...
proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.prototype.setUri = function(value) {
  jspb.Message.setOneofField(this, 1, proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.oneofGroups_[0], value);
};
...
proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.prototype.clearUri = function() {
  jspb.Message.setOneofField(this, 1, proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.oneofGroups_[0], undefined);
};
...
proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.prototype.setDns = function(value) {
  jspb.Message.setOneofField(this, 2, proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.oneofGroups_[0], value);
};
...
proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.prototype.clearDns = function() {
  jspb.Message.setOneofField(this, 2, proto.envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName.oneofGroups_[0], undefined);
};
...
proto.envoy.data.accesslog.v2.TLSProperties.prototype.clearLocalCertificateProperties = function() {
  this.setLocalCertificateProperties(undefined);
};
...
proto.envoy.data.accesslog.v2.TLSProperties.prototype.clearPeerCertificateProperties = function() {
  this.setPeerCertificateProperties(undefined);
};
...
proto.envoy.data.accesslog.v2.HTTPResponseProperties.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    responseCodeDetails: jspb.Message.getFieldWithDefault(msg, 6, "")
  };
...
/**
 * optional string response_code_details = 6;
 * @return {string}
 */
proto.envoy.data.accesslog.v2.HTTPResponseProperties.prototype.getResponseCodeDetails = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.envoy.data.accesslog.v2.HTTPResponseProperties.prototype.setResponseCodeDetails = function(value) {
  jspb.Message.setProto3StringField(this, 6, value);
};
