...
proto.envoy.service.discovery.v2 = require('./ads_pb.js');
 ...
 * @final
 */
proto.envoy.service.discovery.v2.AggregatedDiscoveryServiceClient =
 ...
 * @final
 */
proto.envoy.service.discovery.v2.AggregatedDiscoveryServicePromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
